...
<div>
	...
	<input type="text" id="nombre" name="cosa" placeholder="Nombre de la cosa" class="form-control <?php echo form_error('cosa') ? 'is-invalid':'';?>" value="<?php echo htmlspecialchars(set_value('cosa'))?>"><br>
